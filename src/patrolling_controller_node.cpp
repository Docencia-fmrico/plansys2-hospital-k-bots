...
public:
  ...
  void init_knowledge()
  {
    problem_expert_->addInstance(plansys2::Instance{"k-bot", "robot"});
    ...
    problem_expert_->addInstance(plansys2::Instance{"gripper", "gripper"});

    problem_expert_->addPredicate(plansys2::Predicate("(robot_at k-bot )"));
    problem_expert_->addPredicate(plansys2::Predicate("(robot_in wp_control wp1)"));
